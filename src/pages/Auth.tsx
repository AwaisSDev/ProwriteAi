    ...
    <div className="flex min-h-screen items-center justify-center bg-[#2e0653] px-4 font-sans selection:bg-purple-500 selection:text-white">
      ...
      <div className="w-full max-w-md space-y-8 rounded-3xl border border-white/10 bg-white/5 p-8 backdrop-blur-xl shadow-2xl">
        ...
        <form className="mt-8 space-y-4" onSubmit={(e) => e.preventDefault()}>
          ...
          <button
            type="submit"
            className="group relative flex w-full justify-center rounded-xl bg-gradient-to-r from-purple-600 to-indigo-600 py-3.5 text-sm font-semibold text-white transition-all hover:scale-[1.02] hover:shadow-[0_0_20px_rgba(168,85,247,0.4)] active:scale-95"
          >
        ...
        <div className="grid grid-cols-2 gap-4">
          <button className="flex items-center justify-center rounded-xl border border-white/10 bg-white/5 py-3 text-sm font-medium text-white transition-colors hover:bg-white/10">
        ...
        <p className="text-center text-sm text-purple-200/40">
          ...
          <button 
            ...
            className="font-semibold text-purple-400 hover:text-purple-300 hover:underline underline-offset-4 transition-all"
          >
